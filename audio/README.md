...
The eleven `.m4a` files are synthetic spoken guides, generated locally using the macOS Hindi voice **Lekha** at 105 words per minute and converted to AAC with `afconvert`. They are not recordings of a singer or traditional Vedic recitation. The interface labels them accordingly.
...
- Rama, Krishna (Maha Mantra), Hanuman, Shiva, Maha Mrityunjaya, Narayana, Durga, Lakshmi, Saraswati, and Subrahmanya: [The Divine Life Society — Mantras for Japa](https://www.dlshq.org/teachings/japa-yoga/). The Maha Mantra is stored in the widely chanted Hare Krishna-first order; the reference lists the Hare Rama line first.
